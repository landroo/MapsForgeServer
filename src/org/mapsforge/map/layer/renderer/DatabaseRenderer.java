...
public class DatabaseRenderer implements RenderCallback {
	 ...
	 */
	public TileBitmap executeJob(RendererJob rendererJob, XmlRenderTheme xmlRenderTheme) {

		RenderTheme renderTheme;
		try {
			if(xmlRenderTheme != null) {
				renderTheme = RenderThemeHandler.getRenderTheme(this.graphicFactory, rendererJob.displayModel, xmlRenderTheme);
			} else {
